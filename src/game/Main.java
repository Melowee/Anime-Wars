...
public class Main {
    public static void main(String[] args){
        Character ch1 = CharactersUtils.getCharacterByName("dev", Owner.ALLY);
        Character ch2 = CharactersUtils.getCharacterByName("dev", Owner.ALLY);
        Character ch3 = CharactersUtils.getCharacterByName("dev", Owner.ALLY);
        Character ch4 = CharactersUtils.getCharacterByName("dev", Owner.ALLY);
        
        Character ch5 = CharactersUtils.getCharacterByName("dev", Owner.ENNEMY);
        Character ch6 = CharactersUtils.getCharacterByName("dev", Owner.ENNEMY);
        Character ch7 = CharactersUtils.getCharacterByName("dev", Owner.ENNEMY);
        Character ch8 = CharactersUtils.getCharacterByName("dev", Owner.ENNEMY);
